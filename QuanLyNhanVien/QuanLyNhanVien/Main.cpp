...
{
	danhSachNhanVien.push_back(new FullTimeEmployee("M001", "Luong Xuan Ba", "12/03/2023", "0367259980", 3000000, 3.0, 2));
	danhSachNhanVien.push_back(new PartTimeEmployee("M002", "Nguyen Thi Thao ", "28/02/2024", "0965336908", 2000000, 37, 22000));
	danhSachNhanVien.push_back(new FullTimeEmployee("M003", "Huynh Thi Thanh ", "10/08/2023", "0362280768", 3000000, 3.0, 3));
	danhSachNhanVien.push_back(new FullTimeEmployee("M004", "Dang Tuan", "22/01/2024", "0369089332", 2800000, 3.0, 1));
	danhSachNhanVien.push_back(new PartTimeEmployee("M005", "Nguyen Van Bao", "18/09/2023", "0965721554", 3000000, 45, 24000));
